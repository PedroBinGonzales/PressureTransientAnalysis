namespace Team76.PTA.MathFunctions
{
    ...
    {
        #region Exponential Integral Function
        ...
        {
            return ExponentialIntegralEi.Exponential_Integral_Ei(x);
        }

        private static double ExpIntegralEi_old(double x)
        {
            double Ei;
            double x2 = x * x;
            double x3 = x2 * x;
            ...
            if (x >= 1)
            {
                double mm = 0.2677737343
                            + 8.6347608925 * x
                            + 18.059016973 * x2
                            + 8.5733287401 * x3
                            + x4;

                double nn = 3.9584969228
                            + 21.09965308277 * x
                            + 25.632956486 * x2
                            + 9.5733223454 * x3
                            + x4;
        ...
        /// </summary>
        private static class ExponentialIntegralEi
        {
            ...
            static double epsilon = 10.0 * double.Epsilon;
            ...
            /// <param name="x"></param>
            /// <returns></returns>
            public static double Exponential_Integral_Ei(double x)
            {
                return xExponential_Integral_Ei(x);
            }
            ...
            static double xExponential_Integral_Ei(double x)
            {
                if (x < -5.0) return Continued_Fraction_Ei(x);
                if (x == 0.0) return -double.MaxValue;
