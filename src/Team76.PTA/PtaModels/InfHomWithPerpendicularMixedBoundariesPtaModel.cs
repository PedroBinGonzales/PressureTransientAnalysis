...
{
    /// <summary>
    /// Infinite Homogenous With Perpendicular Mixed Boundaries PTA Model
    /// </summary>
    public class InfHomWithPerpendicularMixedBoundariesPtaModel : InfHomPtaModel
    {
        ...
        public InfHomWithPerpendicularMixedBoundariesPtaModel(Fluid fluid, Well well, Reservoir reservoir, double l1, double l2) : base(fluid, well, reservoir)
        {
            _l1 = l1;
            _l2 = l2;
        }
        ...
        private double PwDbPerpendicularMixedBoundaries(double td)
        {
        ...
        {
            return Laplace.InverseTransform(PwdRinLaplaceSpace, td) + PwDbPerpendicularMixedBoundaries(td);
        }
    }
}