...
{
    /// <summary>
    /// Infinite Homogenous With Perpendicular Constant Pressures PTA Model
    /// </summary>
    public class InfHomWithPerpendicularConstantPressuresPtaModel : InfHomPtaModel
    {
        ...
        /// <param name="l1">distance to linear constant pressure 1, [ft]</param>
        /// <param name="l2">distance to linear constant pressure  2, [ft]</param>
        public InfHomWithPerpendicularConstantPressuresPtaModel(Fluid fluid, Well well, Reservoir reservoir, double l1, double l2) : base(fluid, well, reservoir)
        {
            _l1 = l1;
            _l2 = l2;
        }
        ...
        private double PwDbPerpendicularConstantPressures(double td)
        {
        ...
        {
            return Laplace.InverseTransform(PwdRinLaplaceSpace, td) + PwDbPerpendicularConstantPressures(td);
        }
    }
}